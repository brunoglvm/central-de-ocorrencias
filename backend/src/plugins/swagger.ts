...
const swaggerConfig = {
  openapi: {
    info: {
      ...
      description: 'API para registro e acompanhamento de ocorrências do condomínio.',
      version: '1.0.0',
    },
  },
      ...
      schema.body = {
        ...
        properties: {
          avatar: {
            type: 'string',
            format: 'binary',
            description: 'Arquivo de imagem. Formatos aceitos: JPEG, PNG, WebP, HEIC e HEIF',
          },
        },
      }
    }
      ...
      schema.body = {
        ...
        properties: {
          ...
          source: {
            ...
            description: 'Origem da ocorrência: EMPLOYEE para funcionários e RESIDENT para moradores',
          },
          occurrence: {
            type: 'string',
            format: 'binary',
            description: 'Arquivo de imagem opcional da ocorrência. Formatos aceitos: JPEG, PNG, WebP, HEIC e HEIF',
          },
        },
      }
    }
