  ...
  app.post(
    '/auth/login',
    {
      schema: {
        ...
        description: 'Autentica um administrador através de email e senha e retorna um token JWT.',
        body: z.object({
        ...
        response: {
          ...
          401: z
            .object({
              error: z.string().describe('Mensagem indicando que as credenciais são inválidas'),
            })
