    ...
    '/me',
    {
      schema: {
        ...
        response: {
          ...
          404: z
            .object({
              error: z.string().describe('Mensagem indicando que o administrador não foi encontrado'),
            })
    ...
    '/me/avatar',
    {
      schema: {
        ...
        response: {
          ...
          400: z
            .object({
              error: z.string().describe('Mensagem descrevendo o erro relacionado ao upload da imagem'),
            })
