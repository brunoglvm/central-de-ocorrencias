...
import { OccurrenceSource, OccurrenceStatus } from '../../prisma/src/generated/prisma/enums.js'

export const occurrenceParamsSchema = z.object({
  id: z.coerce.number().int().positive().describe('Identificador da ocorrência'),
})
